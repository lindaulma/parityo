package fi.softala.jee.demo.d06;
...
public class HenkiloListaTietokantahakuServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String username = "a1602677";
		String password = "nuDIWp47j";
		String url = "jdbc:mariadb://localhost/a1602677";
		...
		try {
			...
			//suoritetaan haku
			String sql = "select id, etunimi, sukunimi from henkilo2";
